...
<html lang="en">
    <head>                        
        <!-- START TITLE -->                  
        <title>XUXU LIPSTICKS | Cập nhật video</title>
                ...
                <div class="app-content app-sidebar-left">
                    ...
                    <div class="app-heading-container app-heading-bordered bottom">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="danhsachvideo.php">Danh sách</a></li>
                    ...
                    <div class="container">
                         <div class="row">
                            ...
                            <?php
                                ...
                                $query_id="SELECT title,link,ordernum,status FROM video WHERE id={$id}";
                                $results_id=mysql_query($query_id);
                                if(mysql_num_rows($results_id)==1)
                                {
                                    list($title,$link,$ordernum,$status)=mysql_fetch_array($results_id,MYSQL_NUM);
                                }
                                else
                                {
                            ...
                            ?>
                                <form name="frmthemvideo" method="POST">
                                    ...
                                    ?>
                                    <h3>Cập nhật video: <?php if(isset($title)){echo $title;} ?></h3>
                                    <div class="form-group">
                                        <label>Tiêu đề</label>
                                        <input type="text" name="txttitle" value="<?php if(isset($title)){echo $title;} ?>" class="form-control" placeholder="Title">
                                        <?php 
                                    ...
                                    <div class="form-group">
                                        <label>Link</label>
                                        <input type="text" name="txtlink" value="<?php if(isset($link)){echo $link;} ?>" class="form-control" placeholder="Video">
                                        <?php 
