            ...
            <div class="app-container">                
                ...
                <div class="app-content app-sidebar-left">
                    ...
                    <div class="app-heading app-heading-bordered app-heading-page">                        
                        <div class="title">
                            <h1 style="font-size: 20px;">Danh sách loại sản phẩm</h1>
                        </div>
                                ...
                                <table class="table table-striped table-bordered datatable-extended">
									...
									?>    
                                        <tr>
                                            ...
                                            <td><img width="50px" height="50px" src="../image/loai/<?php echo $row['anh_nen']; ?>" /></td>
                            				<td><a href="capnhatloaisanpham.php?id=<?php echo $row['id_loai']; ?>"><span class="icon-pencil"></span></a></td>
                            				<td><a href="delete_typeproduct.php?id=<?php echo $row['id_loai']; ?>" onClick="return confirm('Bạn có thực sự muốn xóa loại này không ?');"><span class="icon-trash"></a></td>
                       					</tr>
                        			<?php } ?>
                    				</tbody>
                                </table> 
