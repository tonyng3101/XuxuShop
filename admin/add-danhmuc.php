            ...
            <div class="container-fluid">
                ...
                <div id="manage-table">
                    ...
                    <?php
						...
						mysql_select_db('quanlycuahang', $con);
					...
					?>
                    	<div class="form-catalog">
                            <form action="danhmuc/add.php" method="post" id="form-catalog" enctype="multipart/form-data">
                                <table border="0">
                                    <tr id="row2">
                                    	<td style="padding-bottom:10px; width:70px;"><b>Tên hãng: </b></td>
                                    </tr>
                                    <tr>
                                        <td class="add"><input type="text" name="txtname" maxlength="50" placeholder="Tên danh mục" required/></td>
                                    </tr>
                                    
                                    <tr id="submit">
                                        <td colspan="2" align="center"><button class="btnadd" type="submit">Thêm</button> <a href="danhmuc.php"><button class="btnback" type="button">Quay lại</button></a></td>
                                    </tr>
                                </table>
                            </form>
                            ...
                            $(document).ready(function() {
                                ...
                                $("#form-catalog").validate({
                                    ...
                                    messages: {
                                        txtname: "<br>*Vui lòng nhập tên hãng"
                                    }
                                });
                            });
                            </script>
